...
CREATE TABLE `review_picture` (
  `picture_no` int(11) NOT NULL AUTO_INCREMENT,
  `num` int(11) NOT NULL,
  `review_picture_url` text,
  PRIMARY KEY (`picture_no`),
  KEY `fk_review_picture_review1_idx` (`num`),
  CONSTRAINT `fk_review_picture_review1` FOREIGN KEY (`num`) REFERENCES `review` (`num`) ON DELETE CASCADE
...
-- Dump completed on 2019-08-07 13:27:37
