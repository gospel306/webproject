...
CREATE TABLE `review_comment` (
  ...
  KEY `fk_review_comment_member1_idx` (`id`),
  KEY `fk_review_comment_review1_idx` (`num`),
  CONSTRAINT `fk_review_comment_member1` FOREIGN KEY (`id`) REFERENCES `member` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_review_comment_review1` FOREIGN KEY (`num`) REFERENCES `review` (`num`) ON DELETE CASCADE
